...
```bash
git clone git@github.com:caromimo/dogs-vs-cats.git
```
...
### Download the data
Download the [data](https://www.kaggle.com/c/dogs-vs-cats/data) and save locally in you `data/raw` folder without changing the file name.
